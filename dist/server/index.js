...
async function uploadImage(buffer, path, options) {
  ...
  const cleanPath = path.startsWith("/") ? path.substring(1) : path;
  const fileName = (options == null ? void 0 : options.name) || "upload.png";
  const useRandom = !(options == null ? void 0 : options.name);
...
async function requestClientScreenshot(playerSrc, path, options, timeoutMs = 1e4) {
